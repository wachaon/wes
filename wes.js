try {
    ...
    if (!argv.has('engine', 'Chakra')) {
        ...
        var Modules = {
            ...
            version: {
                source: "module.exports = console.log('0.8.16')",
                mapping: {},
                path: '{wes}/version'
            }
        }
