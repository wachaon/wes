    ...
    */
    if ('has' in argv ? argv.has('engine', 'Chakra') : argv.get('engine') == null) {
        ...
        var Modules = {
            ...
            version: {
                source: "module.exports = console.log('0.8.9')",
                mapping: {},
                path: '{wes}/version'
            }
        }
