...
describe( '# ECMA2017', () => {
    describe( '## Object.values / Object.entries', () => {
        ...
        it( 'Object.entries', () => {
            assert( JSON.stringify( Object.entries( obj ) ) === '[["name","simba"],["type","cat"]]' )
        } )
    } )
    ...
    describe( '## Trailing commas in function parameter lists and calls' , () => {
        it( '{ name: "simba", type: "cat", }', () => {
            assert( JSON.stringify( { name: "simba", type: "cat", } ) === '{"name":"simba","type":"cat"}' )
        } )
        it( 'function add ( a, b, ) { return a + b }', () => {
            assert ( ( function add ( a, b, ) { return a + b } )( 2, 3 ) === 5 )
        } )
    } )
    describe( '## Object.getOwnPropertyDescriptors', () => {
        it( 'getOwnPropertyDescriptors', () => {
            const obj = { name: 'simba', type: 'cat' }
            assert( JSON.stringify( Object.getOwnPropertyDescriptors( obj ) ) === '{"name":{"value":"simba","writable":true,"enumerable":true,"configurable":true},"type":{"value":"cat","writable":true,"enumerable":true,"configurable":true}}' )
        } )
    } )
    /*
