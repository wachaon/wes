...
function throws(value, expected, message) {
    try {
        ...
        if (error instanceof Error) {
            /*
            console.log('error.constructor: // => %O', error.constructor)
            console.log('expected.constructor: // => %O', expected.constructor)
            console.log('expected.constructor === Error: // => %O', expected.constructor === Error)
            console.log('expected.constructor === String: // => %O', expected.constructor === String)
            console.log('expected.constructor === RegExp: // => %O', expected.constructor === RegExp)
            */
