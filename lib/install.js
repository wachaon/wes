...
const { options, named, security } = argv

/* Change the process when the migration of argv implementation is completed
    -| if ('has' in argv ? argv.has('core') || argv.has('global') : argv.get('core') != null || argv.get('global') != null) {
    +| if (argv.has('core') || argv.has('global')) {
*/

if ('has' in argv ? argv.has('core') || argv.has('global') : argv.get('core') != null || argv.get('global') != null) {
    if (!security(security.unsafe))
        throw new Error(
