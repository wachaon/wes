const VBScript = (function VBScript(language) {
...
VBScript.AddCode(`
Function ToDate (varDate)
    ToDate = Year(varDate) & "/" & Month(varDate) & "/" & Day(varDate) & " " & _
    Hour(varDate) & ":" & Minute(varDate) & ":" & Second(varDate)
End Function
`)

const ToDate = function toDate(varDate) {
    return new Date(VBScript.Run('ToDate', varDate))
}

module.exports = Object.assign(VBScript, {
    TypeName,
    VarType,
    Type,
    ToDate
