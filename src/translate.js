...
//console.log('%O', charset)

const inspect = require('unist-util-inspect')
const remark = require('remark')()
const { api } = require('/account').google_apps_script
const md_translate = require('markdown-translate')(api, { source: 'ja'})
...
charset.forEach(list => {
    ...
    res = lang === 'ja' ? readme : md_translate(readme, { target: lang })
