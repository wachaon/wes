...
আপনি যদি ইতিমধ্যে *wes* ডাউনলোড করে থাকেন, তাহলে আপনি নিম্নলিখিত কমান্ডের মাধ্যমে এটি আপডেট করতে পারেন।
...
আপনি দুটি ফাঁকা লাইন না দেওয়া পর্যন্ত *REP* স্ক্রিপ্ট ইনপুট গ্রহণ করে। আপনি *REP* এর সাথে README.md-এ নমুনা স্ক্রিপ্টের *README.md* পরীক্ষা করতে পারেন।
...
`module.exports` বরাদ্দ করে মডিউল পরিচালনা করুন এবং `require()` এর সাথে কল করুন। `./` এবং `../` দিয়ে শুরু হওয়া পরম পাথ এবং আপেক্ষিক পাথ ছাড়া অন্য পাথগুলির জন্য, *wes_modules* ডিরেক্টরিতে মডিউলগুলি সন্ধান করুন এবং সুবিধার জন্য, *node_modules* ডিরেক্টরিটি দেখুন৷
...
*Chakra* , যা স্ক্রিপ্টের এক্সিকিউশন ইঞ্জিন, সিনট্যাক্সকে ব্যাখ্যা করে যেমন `imoprt` , কিন্তু এটি কার্যকর করা যায় না কারণ এটি `cscript` হিসাবে প্রক্রিয়াকরণ পদ্ধতি সংজ্ঞায়িত করা হয়নি। *wes* এ , বিল্ট-ইন মডিউলে ব্যাবেল যোগ করে, আমরা এটি কার্যকর করছি যখন *babel* *es module* স্থানান্তরিত করছি। ফলস্বরূপ, প্রসেসিং ওভারহেড এবং *wes.js* ফাইল একটি খরচ হিসাবে ফুলে গেছে।


*es module* দ্বারা বর্ণিত মডিউলগুলিও `require()` এর জন্য স্থানান্তরিত হয়, তাই *ActiveX* কলগুলি সম্ভব। যাইহোক, এটি *es module* মডিউল ফাইল এনকোডিং স্পেসিফিকেশন সমর্থন করে না। সব স্বয়ংক্রিয় অনুমান দ্বারা পড়া হয়.
...
*REP* সহ কমান্ড লাইন আর্গুমেন্ট লিখুন।
...
প্যাকেজটি *github* এ প্রকাশ করার সময়, প্রয়োজনীয় মডিউলগুলিকে *bundle* করে এবং এটিকে একটি বিন্যাসে পরিবর্তন করে যা ইনস্টলেশনের মাধ্যমে আমদানি করা যেতে পারে।
...
*install* প্রাইভেট রিপোজিটরিতে প্যাকেজ ইনস্টল করতে পারে সেইসাথে *github* পাবলিক রিপোজিটরিতে প্যাকেজ ইনস্টল করতে পারে।


*install* , *@author/repository* সহ প্যাকেজটি উল্লেখ করুন। বাস্তবায়ন নিম্নলিখিত url ডাউনলোড করার চেষ্টা করবে.
...
এছাড়াও আপনি *token* জীবনকালের মধ্যে কনসোলে প্যাকেজগুলিকে ব্যক্তিগত সংগ্রহস্থলে ইনস্টল করতে পারেন।
...
আপনি যদি স্ক্রিপ্ট বন্ধ করতে চান, `navi.emit('terminate', res)` অথবা ম্যানুয়ালি *Edge* টার্মিনেট করুন।
...
এটি এমন একটি প্যাকেজ যা ব্রাউজারটি পরিচালনাকারী *web driver* একটি অনুরোধ পাঠায়। *@wachaon/edge* বিল্ট। *@wachaon/edge* মত, ব্রাউজার অপারেশনের জন্য একজন *web driver* প্রয়োজন।
