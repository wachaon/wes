...
`module.exports` বরাদ্দ করে এবং `require()` এর সাথে কল করে মডিউল পরিচালনা করুন। `./` এবং `../` দিয়ে শুরু হওয়া পরম পাথ এবং আপেক্ষিক পাথ ছাড়া অন্য পাথগুলির জন্য, *wes_modules* ডিরেক্টরিতে মডিউলগুলি সন্ধান করুন এবং সুবিধার জন্য, *node_modules* ডিরেক্টরিটি দেখুন৷
