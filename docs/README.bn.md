...
*es module* লেখা মডিউলগুলিও `require()` তে রূপান্তরিত হয়, তাই *ActiveX* কলগুলি সম্ভব। যাইহোক, এটি *es module* মডিউল ফাইল এনকোডিং স্পেসিফিকেশন সমর্থন করে না। সব স্বয়ংক্রিয় অনুমান দ্বারা পড়া হয়.
