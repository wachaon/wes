...
এছাড়াও, *wes* এর একটি *REP* রয়েছে, তাই আপনি যদি এটি শুধুমাত্র `wes` দিয়ে শুরু করেন, আপনি সরাসরি স্ক্রিপ্টে প্রবেশ করতে পারেন।
...
আপনি দুটি ফাঁকা লাইন না দেওয়া পর্যন্ত *REP* স্ক্রিপ্ট ইনপুট গ্রহণ করে। আপনি REP-এর সাথে *REP* এ নমুনা স্ক্রিপ্টের *README.md* পরীক্ষা করতে পারেন।
...
*REP* এ নিম্নলিখিত স্ক্রিপ্টটি চালান।
