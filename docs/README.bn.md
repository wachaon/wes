...
আপনি দুটি ফাঁকা লাইন না দেওয়া পর্যন্ত *REP* স্ক্রিপ্ট ইনপুট গ্রহণ করে। আপনি *REP* এ *README.md* এর নমুনা স্ক্রিপ্ট চালানো দেখতে পারেন।
...
একটি *task* পর্যায়ক্রমে একাধিক প্রক্রিয়া সম্পাদন করতে ব্যবহৃত হয়।

### ব্যবহার

যদি প্রক্রিয়াটি দীর্ঘ সময় নেয় তবে কনসোলে অগ্রগতি প্রদর্শন করা ভাল হবে।
...
নিবন্ধন প্রক্রিয়াকরণ. একাধিক প্রক্রিয়া সমান্তরালভাবে নিবন্ধিত এবং প্রক্রিয়া করা যেতে পারে।
...
একটি নির্দিষ্ট প্রক্রিয়া স্থগিত করে।

#### `run()`

সমান্তরাল প্রক্রিয়াকরণ শুরু করুন।

#### `view`

কনসোলে মুদ্রিত অক্ষরগুলি নির্দিষ্ট করে। নিয়মিত বিরতিতে অক্ষর পরিবর্তন করুন।
...
*github* এ একটি প্যাকেজ প্রকাশ করার সময়, প্রয়োজনীয় মডিউলগুলিকে *bundle* করে এবং একটি বিন্যাসে পরিবর্তন করে যা ইনস্টলেশনের মাধ্যমে অন্তর্ভুক্ত করা যেতে পারে। নিরাপত্তার কারণে, *bundle* *.json* *wes* তৈরি করে কারণ আমরা আপনাকে সরাসরি এক্সিকিউটেবল প্যাকেজ অন্তর্ভুক্ত করতে দিই না। প্যাকেজিংয়ের জন্য কিছু শর্ত রয়েছে।
