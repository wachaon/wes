...
`WScript.Echo` *wes* এবং `WScript.StdErr.WriteLine` এর পরিবর্তে *console* ব্যবহার করে। `console.log` দিয়ে কনসোলে অক্ষর আউটপুট করুন। এটি ফরম্যাট করা স্ট্রিংগুলিকেও সমর্থন করে। `%` ফরম্যাটিং অপারেটর ব্যবহার করে একটি ফরম্যাট করা স্ট্রিং আউটপুট করে।
...
আমি <https://github.com/runk/node-chardet> থেকে কিছু বৈশিষ্ট্য ব্যবহার করছি। আপনি এনকোডিং-নির্দিষ্ট অক্ষর বৃদ্ধি করে স্বয়ংক্রিয় অনুমানের নির্ভুলতা বাড়াতে পারেন।
