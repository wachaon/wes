...
*   আপনাকে এনকোডিং ইত্যাদি নিয়ে চিন্তা করতে হবে না কারণ এটি ফাইল পড়ার সময় স্বয়ংক্রিয়ভাবে এনকোডিং অনুমান করতে পারে
...
*wes* একটি বাস্তবায়ন গ্রহণ করে যা রানটাইমে *WScript.Shell* এর `SendKeys` ব্যবহার করে। যদি ডিরেক্টরির পাথ যেখানে *wes.js* সংরক্ষিত হয় সেখানে নন-ASCII অক্ষর থাকে, `SendKeys` সঠিকভাবে কী পাঠাতে পারবে না এবং স্ক্রিপ্টটি চলবে না। অতএব, আপনি যে পাথ *wes.js* সঞ্চয় করবেন তাতে শুধুমাত্র ASCII অক্ষর থাকতে হবে। বিকল্পভাবে, আপনি যদি ইতিমধ্যেই *wes.js* ডাউনলোড করে থাকেন, তাহলে আপনি নীচের কমান্ডটি ব্যবহার করে এটি আপডেট করতে পারেন।
