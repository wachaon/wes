...
মৌলিক প্রক্রিয়াকরণকে সহজ ও মানসম্মত করার জন্য *wes* এর *built-in modules* রয়েছে।
...
*@wachaon/fmt* স্ক্রিপ্ট ফর্ম্যাট করার জন্য *prettier* এর জন্য *wes* প্যাকেজ। এছাড়াও, *@wachaon/fmt* ইনস্টল করার সময় যদি একটি *Syntax Error* ঘটে, তবে ত্রুটিটির অবস্থান দেখানো যেতে পারে।
