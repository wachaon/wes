...
يمكن أن يكتب *minitest* اختبارات بسيطة. بناء جملة بسيط ، تأكيدات قليلة بالعودة إلى المفهوم الأساسي من الإصدار `0.10.71` ، قمنا بتقليل عدد أنواع التأكيدات إلى ثلاثة.
...
*@wachaon/fmt* هي حزمة *prettier* لـ *wes* وتنسيق البرنامج النصي. أيضًا ، إذا حدث *Syntax Error* مع تثبيت *@wachaon/fmt* ، يمكنك الإشارة إلى موقع الخطأ.
...
إذا كان هناك *.prettierrc* (تنسيق JSON) في دليل العمل ، فسوف ينعكس في الإعداد. يمكن استخدام *fmt* مع كل من *CLI* *module* .
