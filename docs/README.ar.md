...
أيضًا ، يحتوي *wes* على *REP* ، لذلك إذا بدأت باستخدام `wes` فقط ، يمكنك إدخال البرنامج النصي مباشرة.
...
يمكن *install* ليس فقط الوحدات النمطية في المستودعات العامة على *github* ، ولكن أيضًا في المستودعات الخاصة.


في *install* ، حدد الوحدة مع *@author/repository* . سيحاول التطبيق تنزيل عنوان url التالي.
