...
يتم استخدام *task* لإجراء عمليات متعددة بشكل دوري.


### إستعمال


إذا كانت العملية تستغرق وقتًا طويلاً ، فسيكون من الجيد عرض التقدم على وحدة التحكم.
...
معالجة التسجيل. يمكن تسجيل عمليات متعددة ومعالجتها بالتوازي.
...
ابدأ المعالجة المتوازية.


#### `view`


يحدد الأحرف التي يتم طباعتها على وحدة التحكم. تبديل الأحرف على فترات منتظمة.
...
ستكون حزمة ترسل طلبات إلى *web driver* الذي يقوم بتشغيل المتصفح. بني في *@wachaon/edge* . كما هو الحال مع *@wachaon/edge* ، يلزم وجود *web driver* منفصل لتشغيل المتصفح.
