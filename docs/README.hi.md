...
आप `ansi.color()` और `ansi.bgColor()` साथ अपना खुद का रंग भी बना सकते हैं। तर्क *RGB* जैसे `255, 165, 0` या *color code* जैसे `'#FFA500'` । यह `orange` जैसे *color name* समर्थन नहीं करता है।
