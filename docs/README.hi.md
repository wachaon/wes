...
*Chakra* , जो स्क्रिप्ट का निष्पादन इंजन है, सिंटैक्स की व्याख्या करता है जैसे कि `imoprt` , लेकिन इसे निष्पादित नहीं किया जा सकता क्योंकि ऐसा इसलिए है क्योंकि `cscript` के रूप में प्रसंस्करण विधि परिभाषित नहीं है। *wes* में, बिल्ट-इन मॉड्यूल में बेबेल जोड़कर, इसे *es module* में क्रमिक रूप से *babel* करते समय निष्पादित किया जाता है। परिणामस्वरूप, प्रोसेसिंग ओवरहेड और *wes.js* फ़ाइल लागत के रूप में फूली हुई है।


*es module* में लिखे गए मॉड्यूल भी ट्रांसपाइल को `require()` में परिवर्तित किया जाता है, इसलिए *ActiveX* कॉल संभव हैं। हालांकि, यह *es module* में मॉड्यूल फ़ाइल एन्कोडिंग विनिर्देश का समर्थन नहीं करता है। सभी स्वचालित अनुमान लगाकर पढ़े जाते हैं।
...
`--bare` विकल्प `author@repository` से `repository` में `require` तर्क को छोड़ सकता है। `--global` विकल्प संस्थापित पैकेज को सभी स्क्रिप्ट के लिए उपलब्ध कराता है। `--node` या `-n` विकल्प को उसी समय निर्दिष्ट किया जाना चाहिए जैसे कि *wes* सुरक्षा विकल्प `--unsafe` या `--dangerous` ।
