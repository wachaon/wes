...
कृपया केवल *ascii* *wes.js* का सेव डेस्टिनेशन पाथ कॉन्फ़िगर करें।
...
*@wachaon/fmt* *wes* के लिए एक *prettier* पैक है और स्क्रिप्ट को प्रारूपित करता है। साथ ही, यदि *@wachaon/fmt* स्थापित है और एक *Syntax Error* होती है, तो आप त्रुटि स्थान इंगित कर सकते हैं।
