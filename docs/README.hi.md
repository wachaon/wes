...
जब तक आप दो रिक्त पंक्तियाँ दर्ज नहीं करते तब तक *REPL* स्क्रिप्ट इनपुट स्वीकार करता है। आप *REPL* के साथ *README.md* में नमूना स्क्रिप्ट के निष्पादन की जांच भी कर सकते हैं।
...
*install* न केवल सार्वजनिक रिपॉजिटरी में *github* पर मॉड्यूल स्थापित कर सकता है, बल्कि निजी रिपॉजिटरी भी स्थापित कर सकता है।


*install* में, मॉड्यूल को *@author/repository* के साथ निर्दिष्ट करें। कार्यान्वयन निम्न url को डाउनलोड करने का प्रयास करेगा।
...
यदि कार्यशील निर्देशिका में *.prettierrc* (JSON प्रारूप) है, तो यह सेटिंग में दिखाई देगा। *fmt* का उपयोग *CLI* (कंसोल इंटरफेस) और *module* दोनों के साथ किया जा सकता है।
