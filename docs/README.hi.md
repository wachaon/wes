...
-   *ECMAScript2015* *Chakra* चलाने के लिए *Windows Script Host* इंजन को *Chakra*
-   चूंकि 32 बिट *cscript.exe* निष्पादित किया गया है, इसलिए 64 बिट वातावरण के लिए विशिष्ट कोई समस्या नहीं है।
-   `require` साथ मॉड्यूल आयात करें
-   मानक आउटपुट के लिए रंगीन वर्ण आउटपुट करता है
-   स्वचालित रूप से फ़ाइल एन्कोडिंग का अनुमान लगाएं
...
कृपया केवल *ascii* *wes.js* के सेव डेस्टिनेशन पाथ को *wes.js* ।
...
आप `ansi.color()` और `ansi.bgColor()` साथ अपने खुद के रंग भी बना सकते हैं। तर्क *RGB* जैसे `255, 165, 0` या *color code* जैसे `'#FFA500'` । आप `orange` जैसे *color name* उपयोग नहीं कर सकते हैं।
...
सुरक्षा कारणों से, *wes* ऐसे प्रारूप में मॉड्यूल आयात नहीं करता है जिसे सीधे निष्पादित किया जा सकता है, इसलिए *bundle* मॉड्यूल के साथ एक *.json* फ़ाइल बनाएं।
