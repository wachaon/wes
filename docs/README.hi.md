...
यदि आपने पहले ही *wes* डाउनलोड कर लिया है, तो आप इसे निम्न कमांड से अपडेट कर सकते हैं।
...
`module.exports` को असाइन करके और `require()` के साथ कॉल करके मॉड्यूल प्रबंधित करें। `./` और `../` से शुरू होने वाले पूर्ण पथ और सापेक्ष पथ के अलावा अन्य पथों के लिए, *wes_modules* निर्देशिका में मॉड्यूल देखें और सुविधा के लिए, *node_modules* निर्देशिका।
...
वाइल्डकार्ड `*` को ज़िप के `path` में लिखा जा सकता है `zip(path, destinationPath)` ।
...
पैकेज को *github* में प्रकाशित करते समय, *bundle* आवश्यक मॉड्यूल को बंडल करता है और इसे एक प्रारूप में बदल देता है जिसे इंस्टॉलेशन द्वारा आयात किया जा सकता है।
...
| `--save--dev` | `-D`          | पैकेज नाम और संस्करण को *package.json* के *devDependencies* क्षेत्र में जोड़ें |
