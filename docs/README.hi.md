...
*WSH (Windows Script Host)* पर *ECMAScript* चलाने के लिए *wes* एक कंसोल फ्रेमवर्क है। *README* का मूल [*japanese*](/README.md) जापानी में होगा। जापानी के अलावा अन्य ग्रंथों का मशीनी अनुवाद किया जाएगा। \\ अन्य भाषाओं में पाठ के लिए, कृपया नीचे से चुनें।
...
*WScript.Shell* *wes* `SendKeys` का उपयोग करते हैं। यदि निर्देशिका का पथ जहां *wes.js* सहेजा गया है, उसमें *ascii* के अलावा अन्य वर्ण हैं, तो `SendKeys` कुंजी को सही ढंग से नहीं भेज सकता है और स्क्रिप्ट को निष्पादित नहीं किया जा सकता है। \\ *wes.js* गंतव्य पथ केवल *ascii* में कॉन्फ़िगर किया जाना चाहिए। यदि आपने पहले ही *wes* डाउनलोड कर लिया है, तो आप इसे निम्न कमांड से अपडेट कर सकते हैं।
...
सदस्य समानता के लिए वस्तुओं की तुलना करता है, संदर्भ से नहीं। \\ NaN `true` `NaN === NaN` `function (){} === function (){}` `/RegExp/g === /RegExp/g` या `{one: {two: 2}} === {one: {two: 2}}` `[1,2,3] === [1,2,3]` आदि। \\ कक्षाओं (वस्तुओं) की तुलना करते समय, वे वही कंस्ट्रक्टर या सुपरक्लास होने चाहिए, जिनकी `actual` `expected` जाती है।
...
सत्यापित करें कि त्रुटि सही ढंग से फेंकी जा रही है। \\ कोई त्रुटि सही है या नहीं, यह इस बात से निर्धारित होता है कि क्या यह अपेक्षित त्रुटि का *constructor* है, या क्या *message* समान है और रेगुलर एक्सप्रेशन *stack* मूल्यांकन पास करता है।
...
4.  `version 0.12.0` से शुरू होकर, कार्यशील निर्देशिका के ऊपर एक निर्देशिका में सीधे मॉड्यूल लोड होने वाले पैकेजों को बंडल नहीं किया जाएगा। ऊपरी निर्देशिका में संकुल *wes_modules* या *node_modules* बंडल किए जा सकते हैं।
