...
*   हमेशा 32-बिट *cscript.exe* उपयोग करता है, इसलिए कोई अद्वितीय 64-बिट समस्या नहीं है
*   पारंपरिक *WSH* की तुलना में अधिक कुशल विकास के लिए मॉड्यूल सिस्टम उपलब्ध है
*   बिल्ट-इन मॉड्यूल मूल प्रसंस्करण का समर्थन करते हैं जैसे फ़ाइल इनपुट/आउटपुट और कंसोल में रंगीन टेक्स्ट आउटपुट
*   आपको एन्कोडिंग आदि के बारे में चिंता करने की ज़रूरत नहीं है क्योंकि यह फ़ाइल को पढ़ते समय स्वचालित रूप से एन्कोडिंग का अनुमान लगा सकता है
*   मॉड्यूल को पैकेज करना और इसे बाहरी रूप से प्रकाशित करना या प्राप्त करना भी संभव है।
*   *WSH* की तुलना में अधिक कृपया त्रुटि विवरण प्रदर्शित करें
...
*wes* केवल *wes.js* फाइल की जरूरत है। डाउनलोड करने के लिए, [*@wachaon/wes*](https://github.com/wachaon/wes) से *wes.js* कॉपी करें या अपने कंसोल में निम्न कमांड चलाएँ।

```bat
bitsadmin /TRANSFER GetWES https://raw.githubusercontent.com/wachaon/wes/master/wes.js %CD%\\wes.js
```

*wes* एक कार्यान्वयन को अपनाता है जो रनटाइम पर *WScript.Shell* के `SendKeys` का उपयोग करता है। यदि निर्देशिका का पथ जहाँ *wes.js* संग्रहीत है, में गैर-ASCII वर्ण शामिल हैं, `SendKeys` कुंजियों को सही ढंग से भेजने में सक्षम नहीं होंगे और स्क्रिप्ट नहीं चलेगी। इसलिए, सुनिश्चित करें कि जिस पथ पर आप *wes.js* संग्रहीत करते हैं, उसमें केवल ASCII वर्ण हों. वैकल्पिक रूप से, यदि आपने पहले ही *wes.js* डाउनलोड कर लिया है, तो आप इसे नीचे दिए गए कमांड का उपयोग करके अपडेट कर सकते हैं।
...
| `--transpile`      | हमेशा *babel-standalone* के साथ कन्वर्ट और रन करें   |
| `--debug`          | स्क्रिप्ट को डिबग मोड में चलाएं                      |
| `--encoding=UTF-8` | पहली फ़ाइल पढ़ने के एन्कोडिंग को निर्दिष्ट करता है   |
...
फ़ाइल को हल्का और बनाए रखने में आसान बनाने के लिए कुछ अंतर्निहित मॉड्यूल को बाहरी मॉड्यूल में बदलें।
...
कंसोल में cmdlets की सूची प्रदर्शित करें।
...
*github* में पैकेज प्रकाशित करते समय, *bundle* आवश्यक मॉड्यूल को बंडल करता है और *bundle.json* बनाता है।
...
4.  `version 0.12.0` से शुरू होकर, कार्यशील निर्देशिका के ऊपर एक निर्देशिका में सीधे मॉड्यूल लोड करने वाले संकुल को बंडल नहीं किया जाएगा। ऊपरी निर्देशिका में पैकेज *wes\_modules* या *node\_modules* बंडल किए जा सकते हैं।

बंडल करने के लिए निम्न आदेश दर्ज करें: क्या बंडल करना है इसके लिए *package.json* देखें।
