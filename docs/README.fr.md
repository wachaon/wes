...
Une *task* est utilisée pour exécuter périodiquement plusieurs processus.

### Usage

Si le processus prend beaucoup de temps, il serait bien d'afficher la progression sur la console.
...
Traitement des registres. Plusieurs processus peuvent être enregistrés et traités en parallèle.
...
Suspend un processus spécifique.
...
Spécifie les caractères qui sont imprimés sur la console. Changez de personnage à intervalles réguliers.
